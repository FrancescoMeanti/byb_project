...
sc.tl.rank_genes_groups(immune_data, groupby="cell_type", method="wilcoxon")

clusters = immune_data.obs["cell_type"].unique()

output_file = "Ranked genes by cluster.xlsx"
